...
import { PharmacyPrescriptionService } from 'src/app/services/pharmacy-prescription.service';
...
export class PharmacyPrescriptionsListComponent implements OnInit {
  ...
  constructor(private prescriptionService: PharmacyPrescriptionService) { 
}
